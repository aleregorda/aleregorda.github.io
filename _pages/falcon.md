...
<small>**FALCON** (**F**em **AL**gorithm for **CO**mputational a**N**alisys) is a FEM code written in Fortran90 used to study large-scale geodynamics system, such as continental rifting and subductions.</small>
